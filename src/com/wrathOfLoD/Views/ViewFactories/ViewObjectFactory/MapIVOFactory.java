...
import com.wrathOfLoD.Views.ViewObjects.DestroyableModelViewObject;
...
public class MapIVOFactory {
    ...
    public static DestroyableModelViewObject generateMapIVO(Item item) {
        //DestroyableModelViewObject ivo = new DestroyableModelViewObject(item);
