...
public class SneakSkillManager extends SkillManager {
    ...
    public SneakSkillManager(int bindWoundsLevel, int bargainLevel, int observationLevel, int pickPocketLevel, int removeTrapLevel, int creepLevel, int rangedWeaponLevel){
